...
<title>शिक्षक अभिभावक संघ</title>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6"><h2>शिक्षक अभिभावक संघ</h2></div>
                    <div class="col-sm-6">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                     ...
                     <tr>
                        <td>३</td>
                        <td>श्री ज्ञान प्रसाद शर्मा</td>
                        <td>सदस्य</td>
                        <td>9856050404</td>
                        <td>अर्जुनचौपारी-४, स्याङ्जा</td>
                    </tr>
                     <tr>
                        <td>४</td>
                        <td>श्री सीता बि.क.</td>
                        <td>सदस्य</td>
                        <td>9819151628</td>
                        <td>आँधिखोला-१, स्याङ्जा</td>
                    </tr>
